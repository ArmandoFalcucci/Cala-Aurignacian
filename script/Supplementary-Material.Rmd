...
```
  **Figure S10.** (**a**) Boxplots with jittered points showing the distribution of the volume (in cubic millimeters) of carinated cores across the studied spits. (**b**) Boxplots with jittered points showing the distribution of the length values of the flaking surfaces of carinated cores across the studied spits. The figure includes the results of the Kruskal-Wallis tests, which are not significant in both cases.
...
```
  **Figure S11.** Examples of bipolar cores from spits AU12 (**a**, **b**) and AU13 (**c**). The figure includes 3D views generated in Artifact3-D and drawings adapted from Benini et al. (1997). The letters in the figure correspond to the following IDs in the associated dataset: **a** = Ca_378; **b** = Ca_379; **c** = Ca_381.
...
```
  **Figure S13.** Boxplots showing the distribution of length (**a**), width (**b**), and thickness (**c**) across the studied spits divided according to raw material type. The figure includes the results of the Kruskal-Wallis test and pairwise comparisons.
